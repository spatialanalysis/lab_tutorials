...
allow us to create neighbours lists directy as with the older **sp** library. 
...
We first start with rook contiguity, which are neighbours that are connected by a
common side. To create our neighbours list we start by making a 
